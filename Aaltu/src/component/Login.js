...
export default class Login extends Component {
  ...
  ; 
      if(localStorage.getItem("Name")===null&&window.location.pathname!=="/login"){

        console.log("session nahi mila")
        this.state.ok="Your session has been expired please log in";
  ...
  render() {
    ...
    return (
      ...
      <div className="container" style={{ marginTop: '80px', width: "30%", border: "1px solid gray", padding: "30px", borderRadius: "50px" }}>
        ...
        <form >
          <h6 style={{color:"red"}}>{this.state.ok}</h6>
